...
-- Started on 2019-10-23 15:37:35 -03
...
--
-- TOC entry 196 (class 1259 OID 25494)
...
--
-- TOC entry 198 (class 1259 OID 25500)
...
--
-- TOC entry 199 (class 1259 OID 25503)
...
--
-- TOC entry 200 (class 1259 OID 25505)
...
--
-- TOC entry 2927 (class 0 OID 25494)
-- Dependencies: 196
-- Data for Name: ceara; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.ceara (ataque, defesa, lado, idc) FROM stdin;
5	5	6	150
5	5	5	200
\.
...
--
-- TOC entry 2928 (class 0 OID 25497)
-- Dependencies: 197
...
--
-- TOC entry 2929 (class 0 OID 25500)
-- Dependencies: 198
-- Data for Name: fluminense; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.fluminense (ataque, defesa, lado, idflu) FROM stdin;
6	5	7	50
\.
...
SELECT pg_catalog.setval('public.sq_ceara', 4, true);
...
SELECT pg_catalog.setval('public.sq_flamengo', 7, true);
...
SELECT pg_catalog.setval('public.sq_fluminense', 1, true);


--
-- TOC entry 2801 (class 2606 OID 25510)
...
--
-- TOC entry 2803 (class 2606 OID 25512)
...
--
-- TOC entry 2805 (class 2606 OID 25514)
...
-- Completed on 2019-10-23 15:37:35 -03
